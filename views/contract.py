...
from repository.patient_contract import insert_patient_contract,select_all_patient_contracts,delete_patient_contract_pid,select_all_unpaid_patient
...
class ContractView(MethodView):
    ...
    def post(self):
        ...
        contracts = select_all_patient_contracts()
